...
public class IniciarSimulacion extends javax.swing.JPanel {
    ...
    //actualiza los comboBox de las hormigas
    ...
    //selecciona lo que se puede editar durante la simulación
    ...
    private void iniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarActionPerformed
        ...
        //se inicia la simulación y se contemplan errores
        try{
            if(App.validarInicio(Integer.parseInt(ciclos.getText()),Integer.parseInt(hormigas.getText()), Double.valueOf(alfa.getText()), Double.valueOf(beta.getText()), Double.valueOf(q.getText()), Double.valueOf(p.getText()))){
            ...
            JOptionPane.showMessageDialog(null , "Valores de simulación erróneos: Ciclos (Entero) - Hormigas (Entero) - Alfa, Beta, Q y P (Racionales) - P menor que 1", "Error", JOptionPane.ERROR_MESSAGE );    
        }
    ...
    private void siguienteCicloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteCicloActionPerformed
        //se gestiona lo que ocurre en cada ciclo
    ...
    private void finalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finalizarActionPerformed
        //se terminan las simulaciones restantes y se muuestra el resumen
    ...
    private void verMejorRecorridoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verMejorRecorridoActionPerformed
        //muestra el mejor recorrido del ciclo
        if (App.mejorRecorridoCiclo!=null){
