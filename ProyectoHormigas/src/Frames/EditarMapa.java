...
public class EditarMapa extends javax.swing.JPanel {
    ...
    //a continuacuón métodos necesarios para actualizar los comboBox
    ...
    private void definirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_definirActionPerformed
        ...
        //se define el inico y el final
        if (cBoxInicio.getSelectedIndex() !=cBoxMeta.getSelectedIndex()){
            ...
            JOptionPane.showMessageDialog(null , "El inicio y la meta deben ser ciudades distintas", "Error", JOptionPane.ERROR_MESSAGE );    
    ...
    private void agregarCiudadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarCiudadActionPerformed
        try{
            ...
            JOptionPane.showMessageDialog(null , "La distancia debe ser un número racional", "Error", JOptionPane.ERROR_MESSAGE );    
    ...
    private void unirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unirActionPerformed
        try{
            //se unen dos ciudades a través de una arista
            Double distancia=Double.parseDouble(distanciaUnir.getText());
            if (cBoxPrimeraCiudad.getSelectedIndex() != cBoxSegundaCiudad.getSelectedIndex()){
                App.enlazarCiudades(cBoxPrimeraCiudad.getSelectedIndex(), cBoxSegundaCiudad.getSelectedIndex(), distancia);
                this.actualizarComboboxCiudades();
                actualizarMiniGrafo();
            }
            else{
                JOptionPane.showMessageDialog(null , "Solo puedes enlazar ciudades distintas", "Error", JOptionPane.ERROR_MESSAGE );
            }
        }
        catch (Exception e){
            JOptionPane.showMessageDialog(null , "La distancia debe ser un número racional", "Error", JOptionPane.ERROR_MESSAGE );
